...
var logger = __webpack_require__(562);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__firebase_util__ = __webpack_require__(557);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__firebase_app__ = __webpack_require__(164);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__firebase_app__ = __webpack_require__(164);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__info_info__ = __webpack_require__(558);
...
var StartPage = /** @class */ (function () {
    function StartPage(navCtrl, afAuth, geolocation, navParams, alertCtrl, clientsProvider, toastCtrl, events, modalCtrl) {
        ...
        this.navCtrl = navCtrl;
        events.subscribe('client:deleted', function (client) {
            _this.loadMap();
    ...
    ;
    StartPage.prototype.updateSearchResults = function () {
        var _this = this;
    ...
    ;
    StartPage.prototype.pushButton = function () {
        var modalCtrl = this.modalCtrl;
        var modal = modalCtrl.create(__WEBPACK_IMPORTED_MODULE_1__info_info__["a" /* InfoPage */]);
        modal.present();
        this.loadMap();
    };
    ;
    StartPage.prototype.markerLoad = function (placeId) {
        var _this = this;
        var lat;
        var lng;
        ...
        this.afAuth.authState.subscribe(function (user) {
            ...
            _this.db.collection(user.uid).get().then(function (docs) {
                docs.forEach(function (coord) {
                    ...
                    var time_one = coord.data().time_chosen.seconds;
    ...
    StartPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_4_ionic_angular__["n" /* NavController */], __WEBPACK_IMPORTED_MODULE_2_angularfire2_auth__["a" /* AngularFireAuth */],
            ...
            __WEBPACK_IMPORTED_MODULE_0__providers_clients_clients__["a" /* ClientsProvider */], __WEBPACK_IMPORTED_MODULE_4_ionic_angular__["s" /* ToastController */], __WEBPACK_IMPORTED_MODULE_4_ionic_angular__["f" /* Events */], __WEBPACK_IMPORTED_MODULE_4_ionic_angular__["m" /* ModalController */]])
    ], StartPage);
    return StartPage;
}());
